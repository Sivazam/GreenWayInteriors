...
export default function ImageMosaic({ images = [] }: ImageMosaicProps) {
  const defaultImages = [
    ...
    { 
      ...
      category: "Hospitality", 
      height: "short" as const,
      imageUrl: "https://plus.unsplash.com/premium_photo-1661962950572-61c3b7b4d5ba?q=80&w=1269&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2000&q=80",
      photographer: "GWY INT"
    },
    { 
      id: 7, 
